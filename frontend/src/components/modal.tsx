    ...
    try {
      ...
      if (title === 'Add new Task') {
        response = await axios.post('http://localhost:3000/api/v1/todos', {
          ...
          dueDate: dueDate, // Include due date in the request
          reminderTime: reminderTime, // Include reminder time in the request
          reminderDays: reminderDays, // Include reminder days in the request
          isCompleted: false,
        }, {
